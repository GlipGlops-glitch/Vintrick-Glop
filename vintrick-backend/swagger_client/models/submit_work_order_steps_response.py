...
class SubmitWorkOrderStepsResponse(object):
    ...
    def __init__(self, status=None, message=None):  # noqa: E501
        """SubmitWorkOrderStepsResponse - a model defined in Swagger"""  # noqa: E501
        self._status = None
        self._message = None
    ...
    @property
    def status(self):
        """Gets the status of this SubmitWorkOrderStepsResponse.  # noqa: E501


        :return: The status of this SubmitWorkOrderStepsResponse.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this SubmitWorkOrderStepsResponse.


        :param status: The status of this SubmitWorkOrderStepsResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def message(self):
        """Gets the message of this SubmitWorkOrderStepsResponse.  # noqa: E501


        :return: The message of this SubmitWorkOrderStepsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this SubmitWorkOrderStepsResponse.


        :param message: The message of this SubmitWorkOrderStepsResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SubmitWorkOrderStepsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubmitWorkOrderStepsResponse):
            return False
