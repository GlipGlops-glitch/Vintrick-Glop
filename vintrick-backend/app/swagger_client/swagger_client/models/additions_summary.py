...
class AdditionsSummary(object):
    ...
    swagger_types = {
        'allergens': 'list[str]',
        'additions': 'list[AdditionSummaryItem]'
    }
    ...
    def __init__(self, allergens=None, additions=None):  # noqa: E501
        """AdditionsSummary - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def allergens(self):
        """Gets the allergens of this AdditionsSummary.  # noqa: E501


        :return: The allergens of this AdditionsSummary.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def allergens(self, allergens):
        """Sets the allergens of this AdditionsSummary.


        :param allergens: The allergens of this AdditionsSummary.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def additions(self):
        """Gets the additions of this AdditionsSummary.  # noqa: E501


        :return: The additions of this AdditionsSummary.  # noqa: E501
        :rtype: list[AdditionSummaryItem]
        """
        return self._additions

    @additions.setter
    def additions(self, additions):
        """Sets the additions of this AdditionsSummary.


        :param additions: The additions of this AdditionsSummary.  # noqa: E501
        :type: list[AdditionSummaryItem]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AdditionsSummary, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdditionsSummary):
            return False
